...
exports.delete_all_notifications = exports.get_unread_notification_count = exports.get_waiter_notification = exports.get_notifications = exports.update_notification_status = exports.send_notification = exports.create_notifications_table = void 0;
...
function get_notifications(waiter) {
    return __awaiter(this, void 0, void 0, function* () {
        let notification = yield connection_1.db.query((0, sql_template_strings_1.SQL) `SELECT item, quantity, status FROM notification 
        WHERE waiter = ${waiter}`);
        return notification;
    });
}
exports.get_notifications = get_notifications;
function get_waiter_notification() {
    return __awaiter(this, void 0, void 0, function* () {
        let waiter = yield connection_1.db.query((0, sql_template_strings_1.SQL) ` SELECT DISTINCT waiter, status FROM notification `);
        return waiter;
    });
}
...
function delete_all_notifications() {
    return __awaiter(this, void 0, void 0, function* () {
        const notification = yield connection_1.db.query((0, sql_template_strings_1.SQL) `DELETE FROM notification `);
        return notification;
    });
}
exports.delete_all_notifications = delete_all_notifications;
