...
function get_item(product, department) {
    return __awaiter(this, void 0, void 0, function* () {
        let result = yield connection_1.db.query((0, sql_template_strings_1.default) `SELECT product, department FROM item 
...
function get_product_price(product) {
    return __awaiter(this, void 0, void 0, function* () {
        let result = connection_1.db.query((0, sql_template_strings_1.default) `SELECT price FROM item WHERE product = ${product}`);
...
function get_all_items_with_category(itemCategory, department) {
    return __awaiter(this, void 0, void 0, function* () {
        let result = connection_1.db.query((0, sql_template_strings_1.default) `SELECT * FROM item WHERE category = ${itemCategory} 
...
function add_item(product, price, category, image, department) {
    return __awaiter(this, void 0, void 0, function* () {
        let result = yield connection_1.db.query((0, sql_template_strings_1.default) `INSERT INTO item(product, price, category, image, department) 
...
function delete_item(item, department) {
    return __awaiter(this, void 0, void 0, function* () {
        let result = yield connection_1.db.query((0, sql_template_strings_1.default) `DELETE FROM item WHERE product = ${item} AND department = ${department}`);
        return result;
    });
}
