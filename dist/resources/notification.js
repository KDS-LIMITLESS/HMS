...
exports.clearNotifications = exports.notificationCount = exports.updateNotificationStatus = exports.waiters = exports.notifications = void 0;
const notifiacation_1 = require("../models/notifiacation");
function notifications(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        let notification = yield (0, notifiacation_1.get_notifications)(req.body.waiter);
...
function waiters(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        let waiter = yield (0, notifiacation_1.get_waiter_notification)();
...
function clearNotifications(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        let clear = yield (0, notifiacation_1.delete_all_notifications)();
        if (clear.rowCount >= 1)
            return res.status(200).send(`OK`);
