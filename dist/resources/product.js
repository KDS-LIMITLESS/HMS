...
function getItemsInCategory(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const reqBody = req.body;
        const result = yield (0, product_1.get_all_items_in_category)(reqBody['category'], reqBody['department']);
        return res.status(200).send(result.rows);
    });
}
...
function getAllDrinksDepartment(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let p = [];
            const result = yield (0, product_1.get_drinks_in_department)(req.body.department);
            result.forEach((item) => {
                let products = {
...
function deleteItem(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (ITEM.rowCount === 1) {
                yield (0, product_1.delete_product)(req.body.product, req.body.department);
                return res.status(200).send("OK");
            }
...
function updateItem(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const ITEM = yield (0, item_1.get_item)(req.body.product);
            if (ITEM.rowCount === 1) {
                yield (0, product_1.update_item)(req.body.product, req.body.price, req.body.department);
